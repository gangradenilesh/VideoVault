    ...
    <div className="flex flex-row h-14 px-4 md:px-5 justify-between items-center sticky top-0 z-20 bg-white dark:bg-black shadow-md">
      ...
      <div className="flex h-5 items-center">
        ...
        <Link to="/" className="flex h-5 items-center">
          <h2 className="text-2xl font-bold text-black md:text-black dark:text-white cursor-pointer flex items-center justify-center">
            <ImVideoCamera className=" mr-5" /> Video Vault
          </h2>
        </Link>
      </div>
      ...
      <div className="flex items-center">
        ...
        <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
          <Link to={"https://github.com/gangradenilesh"}>
            <img
              src="https://avatars.githubusercontent.com/u/20166968?v=4"
              alt="Nilesh Gangrade"
            />
          </Link>
        </div>
